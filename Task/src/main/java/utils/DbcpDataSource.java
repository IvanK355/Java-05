...
public class DbcpDataSource {
    ...
    private static final String urlStart = "jdbc:h2:mem:ACCOUNT;DB_CLOSE_DELAY=-1;INIT=RUNSCRIPT FROM './Task/src/main/resources/schema.sql'\\;RUNSCRIPT FROM './Task/src/main/resources/data.sql'";
    ...
    static {
        dataSource.setUrl("jdbc:h2:mem:ACCOUNT;DB_CLOSE_DELAY=-1;INIT=RUNSCRIPT FROM './Task/src/main/resources/schema.sql'\\;RUNSCRIPT FROM './Task/src/main/resources/data.sql'");
